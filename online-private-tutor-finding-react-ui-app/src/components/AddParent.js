  ...
  render() {
    return (
      <div class="container mt-5 px-3 py-3 border border-dark rounded text-dark form-group required">
        <div class="row">
          <div class="col">
            <h2 class="text-body font-weight-bold">Registration</h2>
            <br></br>
            <form method="post">
              <div>
                <div class="mb-3 row ">
                  <label for="firstName" class="col-sm-4 col-form-label control-label">
                    First Name :
                  </label>
                  <div class="col-sm-5">
                    <input
                ...
                <div class="mb-3 row">
                  <label for="lastName" class="col-sm-4 col-form-label control-label">
                    Last Name :
                  </label>
                  <div class="col-sm-5">
                    <input
                ...
                <div class="mb-3 row">
                  <label for="username" class="col-sm-4 col-form-label control-label">
                    Username :
                  </label>
                  <div class="col-sm-5">
                    <input
                ...
                <div class="mb-3 row">
                  <label for="password" class="col-sm-4 col-form-label control-label">
                    Password :
                  </label>
                  <div class="col-sm-5">
                    <input
                ...
                <div class="mb-3 row">
                  <label for="mobileNo" class="col-sm-4 col-form-label control-label">
                    Mobile No :
                  </label>
                  <div class="col-sm-5">
                    <input
                ...
                <div class="mb-3 row">
                  <label for="email" class="col-sm-4 col-form-label control-label">
                    Email :
                  </label>
                  <div class="col-sm-5">
                    <input
                ...
                <div class="mb-3 row">
                  <label for="address" class="col-sm-4 col-form-label control-label">
                    Address :
                  </label>
                  <div class="col-sm-5">
                    <input
